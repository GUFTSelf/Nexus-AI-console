...
- [ ] Android, iOS, and backend CI pass from a clean checkout.
...
- [ ] The Cloud Run gateway URL, Firebase Auth validation, App Check enforcement, allowed origins, rate limits, and managed secrets are verified in the production project.
